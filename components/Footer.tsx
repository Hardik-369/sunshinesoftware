...
import { company, footerGroups } from "@/data/company";
      ...
      <Container className="py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 font-display text-lg font-bold tracking-tight text-paper/90">
              {company.tagline}
            </p>
              ...
              <div className="mt-7 flex gap-3">
                {socials.map((social) => (
                  <a
                    ...
                    className="grid size-9 place-items-center border border-white/15 text-paper/70 transition-colors duration-200 hover:border-white/60 hover:text-paper"
                  >
                    <BrandIcon path={socialIcons[social.name] ?? socialIcons.GitHub} />
                  </a>
                ))}
              </div>
            )}
